  ...
  const fetchParameters = (guid) => {
    ...
    for (const { type, key } of globalEvent.parameters) {
      ...
      Command.variables.push({
        ...
        type: varType,
        comment:
          this.eventName || "⭐️" + Local.get(`eventParameterTypes.${type}`),
        evIndex: eventIndex,
        isLeftValue: true,
        refCount: 0,
      });
...
Command.parseAttributeKey = (function () {
  ...
  return function (groupKey, attrId, valueType) {
    ...
    if (attr) {
      ...
      return (
        textId +
        Command.setVariableColor(GameLocal.replace(attr.name.replace(i, "")))
      );
    }
    this.invalid = true;
    const textId = Command.setTextId(
...
Command.parseActor = function (actor) {
  switch (actor.type) {
    case "trigger":
      return (
        Command.setTextId("actor-object-trigger") + Local.get("actor.trigger")
      );
    case "caster":
      return (
        Command.setTextId("actor-object-caster") + Local.get("actor.caster")
      );
    case "latest":
      return (
        Command.setTextId("actor-object-latest") + Local.get("actor.latest")
      );
    case "target":
      return (
        Command.setTextId("actor-object-target") + Local.get("actor.target")
      );
    case "player":
      return (
        Command.setTextId("actor-object-player") + Local.get("actor.player")
      );
    case "member":
      return (
...
Command.parseSkill = function (skill) {
  switch (skill.type) {
    case "trigger":
      return (
        Command.setTextId("skill-object-trigger") + Local.get("skill.trigger")
      );
    case "latest":
      return (
        Command.setTextId("skill-object-latest") + Local.get("skill.latest")
      );
    case "by-key": {
      ...
      return (
        actor + Token(" -> ") + textId + label + Token("<") + key + Token(">")
      );
    }
    case "by-id": {
      const actor = Command.parseActor(skill.actor);
...
Command.parseState = function (state) {
  switch (state.type) {
    case "trigger":
      return (
        Command.setTextId("state-object-trigger") + Local.get("state.trigger")
      );
    case "latest":
      return (
        Command.setTextId("state-object-latest") + Local.get("state.latest")
      );
    case "by-id": {
...
Command.parseEquipment = function (equipment) {
  switch (equipment.type) {
    ...
    case "by-slot": {
      ...
      return (
        actor + Token(" -> ") + textId + label + Token("<") + slot + Token(">")
      );
    }
    case "by-id-equipped":
    case "by-id-inventory": {
      ...
      return (
        actor + Token(" -> ") + file + " " + Token("(") + source + Token(")")
      );
    }
    case "variable": {
      const label = Local.get("equipment.common");
...
Command.parseItem = function (item) {
  switch (item.type) {
    case "trigger":
      return (
        Command.setTextId("item-object-trigger") + Local.get("item.trigger")
      );
    case "latest":
...
Command.parseTrigger = function (trigger) {
  switch (trigger.type) {
    ...
    case "latest":
      return (
        Command.setTextId("trigger-object-latest") + Local.get("trigger.latest")
      );
    case "variable": {
...
Command.parseLight = function (light) {
  switch (light.type) {
    case "trigger":
      return (
        Command.setTextId("light-object-trigger") + Local.get("light.trigger")
      );
    case "latest":
      return (
        Command.setTextId("light-object-latest") + Local.get("light.latest")
      );
    case "by-id":
...
Command.parseRegion = function (region) {
  switch (region.type) {
    case "trigger":
      return (
        Command.setTextId("region-object-trigger") + Local.get("region.trigger")
      );
    case "by-id":
...
Command.parseObject = function (object) {
  switch (object.type) {
    case "trigger":
      return (
        Command.setTextId("preset-object-trigger") + Local.get("object.trigger")
      );
    case "latest":
      return (
        Command.setTextId("preset-object-latest") + Local.get("object.latest")
      );
    case "by-id":
...
Command.parseElement = function (element) {
  switch (element.type) {
    ...
    case "latest":
      return (
        Command.setTextId("element-object-latest") + Local.get("element.latest")
      );
    case "by-id":
    ...
    case "focus":
      return (
        Command.setTextId("element-object-focus") + Local.get("element.focus")
      );
    case "parent": {
...
Command.cases.showChoices = {
  ...
  parse: function ({ choices, parameters }) {
    ...
    if (parameters) {
      contents.push(
        ...
        {
          text:
            " " + Token("(") + Command.setCommaColors(parameters) + Token(")"),
        }
      );
    }
  ...
  load: function ({ choices = this.createDefaultChoices(), parameters = "" }) {
...
Command.cases.setBoolean = {
  initialize: function () {
    ...
    $("#setBoolean-operand-type")
      .enableHiddenMode()
      .relate([
        { case: "constant", targets: [$("#setBoolean-constant-value")] },
        { case: "variable", targets: [$("#setBoolean-common-variable")] },
        {
          case: "list",
          targets: [
        ...
        { case: "parameter", targets: [$("#setBoolean-parameter-key")] },
...
Command.cases.setString = {
  initialize: function () {
    ...
    $("#setString-operand-type")
      .enableHiddenMode()
      .relate([
        { case: "constant", targets: [$("#setString-operand-common-value")] },
        {
          case: "variable",
          targets: [$("#setString-operand-common-variable")],
        },
        { case: "template", targets: [$("#setString-operand-common-value")] },
        {
          case: "string",
          targets: [
        ...
        { case: "enum", targets: [$("#setString-operand-enum-stringId")] },
        { case: "object", targets: [$("#setString-operand-object-property")] },
        {
          case: "element",
          targets: [
        ...
        { case: "parameter", targets: [$("#setString-operand-parameter-key")] },
    ...
    $("#setString-operand-string-method")
      .enableHiddenMode()
      .relate([
        { case: "char", targets: [$("#setString-operand-string-char-index")] },
        {
          case: "slice",
          targets: [
    ...
    $("#setString-operand-object-property")
      ...
      .relate([
        ...
        { case: "file-id", targets: [$("#setString-operand-object-fileId")] },
      ]);
  ...
  parseStringMethod: function (operand) {
    ...
    switch (method) {
      case "char": {
        ...
        return (
          methodName + Token("(") + varName + Token(", ") + index + Token(")")
        );
      }
      case "slice": {
  ...
  parseObjectProperty: function (operand) {
    ...
    switch (operand.property) {
      ...
      case "equipment-slot":
        return (
          Command.parseEquipment(operand.equipment) + Token(" -> ") + property
        );
      case "item-file-id":
  ...
  parseOther: function (operand) {
    const label = Local.get("command.setString.other." + operand.data).replace(
      ".",
      Token(".")
    );
    switch (operand.data) {
      ...
      case "parse-timestamp": {
        ...
        return (
          label + Token("(") + variable + Token(", ") + format + Token(")")
        );
      }
      case "screenshot": {
  ...
  initialize: function () {
    ...
    $("#setObject-operand-type")
      ...
      .relate([
        ...
        { case: "equipment", targets: [$("#setObject-operand-equipment")] },
        ...
        { case: "variable", targets: [$("#setObject-operand-variable")] },
        {
          case: "list",
          targets: [
...
Command.cases.forEach = {
  ...
  initialize: function () {
    ...
    $("#forEach-data")
      .enableHiddenMode()
      .relate([
        { case: "list", targets: [$("#forEach-list"), $("#forEach-variable")] },
        {
        ...
        { case: ["touch", "changed-touch"], targets: [$("#forEach-touchId")] },
      ]);
  ...
  parse: function ({
    ...
    switch (data) {
      ...
      case "inventory": {
        ...
        const actorInfo = Command.parseActor(actor);
        words.push(
          varName + Token(" = ") + actorInfo + Token(" -> ") + dataInfo
        );
        break;
      }
      case "element": {
    ...
    if (event) {
      ...
      outer: for (const { type, key, note } of parameters) {
        ...
        const info = `${Command.setClass("error")}${name}${
          Token(": ") +
          Command.setWeakColor(Local.get("eventParameterTypes." + type))
        }`;
        words.push(info);
      }
    }
  ...
  parse: function ({
    ...
    switch (type) {
      case "global": {
        ...
        words.push(
          leftValue + eventName + this.parseEventArgs(event, eventArgs)
        );
        break;
      }
      case "inherited":
...
Command.cases.return = {
  ...
  load: function ({ type = Command.returnType, value = null }) {
    ...
    write(
      "object",
      type === "object" && value !== null ? value : { type: "local", key: "" }
    );
    write(
      "actor",
...
Command.cases.registerEvent = {
  ...
  parse: function ({
        ...
        switch (operation) {
          ...
          case "unregister": {
            const tagName =
              Token("(") + Command.parseVariableString(tag) + Token(")");
            words.push(
              Local.get("command.registerEvent.reset.global-event") + tagName
            );
            break;
          }
          case "reset":
    ...
    const contents = [
      ...
      {
        text:
          Local.get("command.registerEvent.alias." + operation) + Token(": "),
      },
      { text: words.join() },
    ];
    if (commands) {
      ...
      case "global":
        switch (operation) {
          case "register": {
            ...
            const priority = Command.cases.registerEvent.priorityEnabled
              ? read("priority")
              : false;
...
Command.cases.setEvent = {
  initialize: function () {
    ...
    $("#setEvent-operation")
      .enableHiddenMode()
      .relate([
        { case: ["pause", "continue"], targets: [$("#setEvent-variable")] },
        {
          case: ["enable", "disable", "highest-priority"],
          targets: [$("#setEvent-eventId")],
        },
        { case: "goto-choice-branch", targets: [$("#setEvent-choiceIndex")] },
      ]);
  },
...
Command.cases.createElement = {
  initialize: function () {
    ...
    $("#createElement-operation")
      .enableHiddenMode()
      .relate([
        { case: "append-all-to-root", targets: [$("#createElement-uiId")] },
        { case: "append-one-to-root", targets: [$("#createElement-presetId")] },
        {
  ...
  initialize: function () {
    ...
    $("#loadImage-type")
      ...
      .relate([
        ...
        { case: "equipment-icon", targets: [$("#loadImage-equipment")] },
...
Command.cases.setObjectAnimation = {
  initialize: function () {
    ...
    $("#setObjectAnimation-sort")
      ...
      .relate([
        ...
        { case: "trigger", targets: [$("#setObjectAnimation-trigger")] },
        { case: "animation", targets: [$("#setObjectAnimation-animation")] },
      ]);
    ...
    $("#setObjectAnimation-operation")
      ...
      .relate([
        ...
        { case: "set-gray", targets: [$("#setObjectAnimation-tint-3")] },
        { case: "set-opacity", targets: [$("#setObjectAnimation-opacity")] },
        { case: "set-offsetY", targets: [$("#setObjectAnimation-offsetY")] },
        { case: "set-rotation", targets: [$("#setObjectAnimation-rotation")] },
      ]);
  ...
  parseProperty: function (operation, property) {
    const label = Local.get("command.setObjectAnimation." + operation);
    return (
      label + Token("(") + Command.parseVariableNumber(property) + Token(")")
    );
  },
  parse: function ({
    sort,
...
Command.cases.getActor = {
  initialize: function () {
    ...
    $("#getActor-selector")
      .enableHiddenMode()
      .relate([
        { case: ["enemy", "friend", "team"], targets: [$("#getActor-teamId")] },
      ]);
  ...
  parse: function ({
    ...
    switch (exclusion) {
      case "actor": {
        ...
        words.push(
          label + Token("(") + Command.parseActor(exclusionActor) + Token(")")
        );
        break;
      }
      case "team": {
...
Command.cases.changeActorState = {
  initialize: function () {
    ...
    $("#changeActorState-operation")
      .enableHiddenMode()
      .relate([
        { case: ["add", "remove"], targets: [$("#changeActorState-stateId")] },
        { case: "remove-instance", targets: [$("#changeActorState-state")] },
      ]);
  },
  parseOperation: function (operation) {
  ...
  initialize: function () {
    ...
    $("#changeActorEquipment-operation")
      ...
      .relate([
        ...
        { case: "remove", targets: [$("#changeActorEquipment-equipmentId")] },
        {
          case: "add-instance",
          targets: [
            $("#changeActorEquipment-slot"),
        ...
        { case: "remove-slot", targets: [$("#changeActorEquipment-slot")] },
      ]);
  },
...
Command.cases.changeActorSkill = {
  initialize: function () {
    ...
    $("#changeActorSkill-operation")
      .enableHiddenMode()
      .relate([
        { case: ["add", "remove"], targets: [$("#changeActorSkill-skillId")] },
        { case: "remove-instance", targets: [$("#changeActorSkill-skill")] },
      ]);
  },
  parseOperation: function (operation) {
  ...
  initialize: function () {
    ...
    $("#changeActorPortrait-mode")
      ...
      .relate([
        ...
        { case: "portrait", targets: [$("#changeActorPortrait-portrait")] },
...
Command.cases.changeActorMotion = {
  ...
  load: function ({ actor = { type: "trigger" }, type = "move", motion = "" }) {
  ...
  initialize: function () {
    ...
    $("#setAnimationComponent-operation").loadItems([
      ...
      $("#setAnimationComponent-operation")
        .enableHiddenMode()
        .relate([
          { case: "set-angle", targets: [$("#setAnimationComponent-angle")] },
          { case: "set-scale", targets: [$("#setAnimationComponent-scale")] },
          { case: "set-speed", targets: [$("#setAnimationComponent-speed")] },
          {
            case: "set-opacity",
...
Command.cases.setShortcut = {
  initialize: function () {
    ...
    $("#setShortcut-operation")
      .enableHiddenMode()
      .relate([
        { case: "set-item-shortcut", targets: [$("#setShortcut-itemId")] },
        { case: "set-skill-shortcut", targets: [$("#setShortcut-skillId")] },
  ...
  parse: function ({ actor, operation, itemId, skillId, key, key2 }) {
    ...
    switch (operation) {
      case "set-item-shortcut": {
        words.push(
          shortcutKey + Token(" = ") + Command.parseVariableFile(itemId)
        );
        break;
      }
      case "set-skill-shortcut":
        words.push(
          shortcutKey + Token(" = ") + Command.parseVariableFile(skillId)
        );
        break;
...
Command.cases.setAmbientLight = {
  ...
  parseColor: function (red, green, blue) {
    ...
    return (
      "RGB" + Token("(") + r + Token(", ") + g + Token(", ") + b + Token(")")
    );
  },
  ...
  save: async function () {
    ...
    try {
      ...
      if (currentLanguage === "javascript") {
        ...
        script = await require("electron").ipcRenderer.invoke("tsc-file", script);
        if (script.error) {
          throw script.error;
        }
        script =  script.res
...
NumberOperand.initialize = function () {
  ...
  $("#setNumber-operand-type")
    .enableHiddenMode()
    .relate([
      { case: "constant", targets: [$("#setNumber-operand-constant-value")] },
      { case: "variable", targets: [$("#setNumber-operand-common-variable")] },
      ...
      { case: "object", targets: [$("#setNumber-operand-object-property")] },
      {
        case: "element",
        targets: [
      ...
      { case: "parameter", targets: [$("#setNumber-operand-parameter-key")] },
  ...
  $("#setNumber-operand-other-data")
    ...
    .relate([
      ...
      { case: "actor-count", targets: [$("#setNumber-operand-other-teamId")] },
    ]);
...
NumberOperand.parseOther = function (operand) {
  ...
  switch (operand.data) {
    ...
    case "actor-count":
      return (
        label + Token("(") + Command.parseTeam(operand.teamId) + Token(")")
      );
    default:
...
IfCondition.initialize = function () {
  ...
  $("#if-condition-number-operand-type")
    .enableHiddenMode()
    .relate([
      { case: "constant", targets: [$("#if-condition-number-constant-value")] },
      { case: "variable", targets: [$("#if-condition-operand-variable")] },
    ]);
  ...
  $("#if-condition-string-operand-type")
    .enableHiddenMode()
    .relate([
      { case: "constant", targets: [$("#if-condition-string-constant-value")] },
      { case: "variable", targets: [$("#if-condition-operand-variable")] },
  ...
  $("#if-condition-object-operand-type")
    ...
    .relate([
      ...
      { case: "equipment", targets: [$("#if-condition-common-equipment")] },
  ...
  $("#if-condition-actor-operation")
    ...
    .relate([
      ...
      { case: "equipped", targets: [$("#if-condition-actor-equipmentId")] },
      {
...
SwitchCondition.initialize = function () {
  ...
  $("#switch-condition-type")
    .enableHiddenMode()
    .relate([
      { case: "boolean", targets: [$("#switch-condition-boolean-value")] },
      ...
      { case: "keyboard", targets: [$("#switch-condition-keyboard-keycode")] },
      { case: "gamepad", targets: [$("#switch-condition-gamepad-button")] },
      { case: "mouse", targets: [$("#switch-condition-mouse-button")] },
      { case: "variable", targets: [$("#switch-condition-variable-variable")] },
    ]);
...
SwitchCondition.parse = function (condition, listData) {
  ...
  switch (condition.type) {
    ...
    case "gamepad": {
      ...
      string =
        gamepad + Token("[") + Command.setStringColor(button) + Token("]");
      break;
    }
    case "mouse": {
...
ImageProperty.parse = function ({ key, value }, listData) {
  ...
  switch (key) {
    ...
    case "clip-3":
      string =
        name + Token("(") + Command.parseVariableNumber(value) + Token(")");
      break;
  }
  if (listData) {
    string = Command.removeTextTags(string);
...
TextProperty.initialize = function () {
  ...
  $("#setText-property-key")
    ...
    .relate([
      ...
      { case: "lineSpacing", targets: [$("#setText-property-lineSpacing")] },
      {
        case: "letterSpacing",
...
TextProperty.parse = function ({ key, value }, listData) {
  ...
  switch (key) {
    case "content":
      string =
        name + Token("(") + Command.parseVariableTemplate(value) + Token(")");
      break;
    case "size":
    case "lineSpacing":
    case "letterSpacing":
...
TextBoxProperty.parse = function ({ key, value }, listData) {
  ...
  switch (key) {
    ...
    case "text": {
      ...
      string =
        name + Token("(") + Command.parseVariableString(text) + Token(")");
      break;
    }
    case "number":
    case "min":
...
DialogBoxProperty.initialize = function () {
  ...
  $("#setDialogBox-property-key")
    ...
    .relate([
      ...
      { case: "interval", targets: [$("#setDialogBox-property-interval")] },
      ...
      { case: "effect", targets: [$("#setDialogBox-property-effect-type")] },
  ...
  $("#setDialogBox-property-effect-type")
    ...
    .relate([
      ...
      { case: "outline", targets: [$("#setDialogBox-property-effect-color")] },
    ]);
...
ProgressBarProperty.initialize = function () {
  ...
  $("#setProgressBar-property-key")
    ...
    .relate([
      ...
      { case: "display", targets: [$("#setProgressBar-property-display")] },
      { case: "blend", targets: [$("#setProgressBar-property-blend")] },
      { case: "progress", targets: [$("#setProgressBar-property-progress")] },
      ...
      { case: "color-0", targets: [$("#setProgressBar-property-color-0")] },
      { case: "color-1", targets: [$("#setProgressBar-property-color-1")] },
      { case: "color-2", targets: [$("#setProgressBar-property-color-2")] },
      { case: "color-3", targets: [$("#setProgressBar-property-color-3")] },
    ]);
...
AnimationProperty.initialize = function () {
  ...
  $("#setAnimation-property-key")
    .enableHiddenMode()
    .relate([
      { case: "animation", targets: [$("#setAnimation-property-animation")] },
      {
...
VideoProperty.initialize = function () {
  ...
  $("#setVideo-property-key")
    ...
    .relate([
      ...
      { case: "playbackRate", targets: [$("#setVideo-property-playbackRate")] },
...
WindowProperty.initialize = function () {
  ...
  $("#setWindow-property-key")
    ...
    .relate([
      ...
      { case: "gridWidth", targets: [$("#setWindow-property-gridWidth")] },
      { case: "gridHeight", targets: [$("#setWindow-property-gridHeight")] },
...
TransformProperty.initialize = function () {
  ...
  $("#moveElement-property-key")
    ...
    .relate([
      ...
      { case: "rotation", targets: [$("#moveElement-property-rotation")] },
...
TransformProperty.parse = function ({ key, value }, listData) {
  ...
  let string =
    Local.get("command.moveElement." + key) + Token("(") + number + Token(")");
  if (listData) {
    string = Command.removeTextTags(string);
  }
  return string;
...
LightProperty.initialize = function () {
  ...
  $("#moveLight-property-key")
    ...
    .relate([
      ...
      { case: "intensity", targets: [$("#moveLight-property-intensity")] },
  ...
  switch (filter) {
    ...
    case "object":
      ...
      $("#variableGetter-type").loadItems(
        !Window.isWindowOpen("elementGetter") ? types.object : types.object2
      );
      $("#variableGetter-global-key").filter = filter;
      break;
...
VariableGetter2.confirm = function (event) {
  ...
  switch (type) {
    ...
    case "global": {
      ...
      if (
        key === "" ||
        (this.filter !== "all" && typeof variable?.value !== this.filter)
      ) {
...
AngleGetter.initialize = function () {
  ...
  $("#angleGetter-type")
    .enableHiddenMode()
    .relate([
      { case: "position", targets: [$("#angleGetter-position-position")] },
      {
...
ElementGetter.initialize = function () {
  ...
  $("#elementGetter-type")
    ...
    .relate([
      ...
      { case: "selected-button", targets: [$("#elementGetter-ancestor")] },
      { case: ["parent", "variable"], targets: [$("#elementGetter-variable")] },
    ]);
